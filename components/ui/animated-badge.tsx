...
const AnimatedBadge = ({
  ...
  const content = (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group relative flex max-w-fit items-center justify-center gap-3 px-4 py-1.5"
    >
      <div className="pointer-events-none absolute inset-x-0 bottom-full h-30 w-[205px]">
        <svg
