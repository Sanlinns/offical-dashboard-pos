...
//     description: "Beautiful scroll-based motion for modern landing pages.",
//   },
//   {
//     title: "Clean Navigation",
//     description: "Sticky glass navbar with mobile-friendly menu.",
//   },
//   {
//     title: "Light & Dark",
//     description: "Theme toggle with localStorage support.",
//   },
// ];
...
//                 <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-blue-200/80 bg-blue-50/80 px-4 py-2 text-sm font-bold text-blue-700 shadow-sm backdrop-blur dark:border-blue-400/20 dark:bg-blue-400/10 dark:text-blue-200">
...
//         >
//           <div className="rounded-[2rem] border border-white/70 bg-gradient-to-br from-slate-950 to-slate-800 p-8 text-white shadow-2xl shadow-slate-900/20 dark:border-white/10 md:p-12">
//             <div className="mx-auto max-w-3xl text-center">
//               <h2 className="text-3xl font-black tracking-tight md:text-5xl">
//                 Ready to build a beautiful page?
//               </h2>

//               <p className="mt-4 text-slate-300">
//                 Replace this area with your contact form, footer links, or final
//                 call-to-action section.
//               </p>

//               <Link
//                 href="/"
//                 className="mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-black text-slate-950 transition hover:-translate-y-0.5 hover:bg-slate-100"
//               >
//                 Back Home
//                 <ArrowRight className="h-4 w-4" />
//               </Link>
